...
// MARK: - History Palette Detail View
            ...
            HStack(spacing: DSSpacing.md) {
                ...
                Button {
                    ...
                    Image(systemName: isCopied ? "checkmark" : "doc.on.doc")
                        ...
                        .frame(width: 32, height: 32)
                        .background(
                            isCopied ? DSColors.Preview.success.opacity(0.12) : DSColors.Preview.backgroundTertiary,
                            in: Circle()
                        )
